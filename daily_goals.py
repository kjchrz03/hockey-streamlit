...
from airflow.providers.git.sensors.git import GitSensor
from airflow.providers.git.operators.git import GitOperator
...
def daily_scrape():
    goal_counts_df = '/mnt/c/Users/bsear/OneDrive/Desktop/Github/hockey-streamlit/data/goal_counts.csv'
    goal_counts_df = pd.read_csv(goal_counts_df)

    goal_location_df = '/mnt/c/Users/bsear/OneDrive/Desktop/Github/hockey-streamlit/data/goal_locations.csv'
    ...
    file_path3 = '/mnt/c/Users/bsear/OneDrive/Desktop/Github/hockey-streamlit/data/ice_map_data.csv'
...
# Define your DAG
dag = DAG('daily_scrape_goals_dag', default_args=default_args, schedule_interval='0 7 * * *')

# Task to check Git changes
check_git_changes = GitSensor(
    task_id='check_git_changes',
    repo_path='/mnt/c/Users/bsear/OneDrive/Desktop/Github/hockey-streamlit',
    branch='main',
    poke_interval=3600,  # Adjust as needed
    timeout=7200,
    dag=dag,
)

# Task to fetch and update Git repository
fetch_and_update_git = GitOperator(
    task_id='fetch_and_update_git',
    repo_path='/mnt/c/Users/bsear/OneDrive/Desktop/Github/hockey-streamlit',
    command='fetch --all && reset --hard origin/main',
    dag=dag,
)

# Task to run your daily_scrape function
...
check_git_changes >> fetch_and_update_git >> run_script_task
