...
#         return print(team_rosters.head())
#     except Exception as e:
#         print(f"Error loading roster data: {e}")
#         return None
    
# # Define the get_season_data function
# def get_season_data(team_rosters, season_totals):
#     # Combine or process the dataframes here
#     season_data = pd.merge(team_rosters, season_totals, on='player_id') 
#     return season_data

# # # Function to load and process the data
# # def load_season_data():
# #     try:
# #         # Load the dataframes using the defined loading functions
# #         team_rosters = load_roster_data()  # Load roster data
# #         season_totals = load_player_data()  # Load player season data
        
# #         # Ensure both DataFrames are valid before processing
# #         if team_rosters is not None and season_totals is not None:
# #             # Pass the loaded DataFrames to get_season_data
# #             combined_df = get_season_data(team_rosters, season_totals_df)
# #             print(combined_df)  # Display or further process the combined DataFrame
# #             return combined_df
# #         else:
# #             print("Error: One or both data frames are None, cannot proceed.")
# #             return None
# #     except Exception as e:
# #         print(f"Error loading season data: {e}")
# #         return None

# # # You would call load_season_data to execute the entire process:
